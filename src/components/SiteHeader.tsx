...
const navLinks = [
  { href: "/exosome#services", label: "診療案内" },
  { href: "/exosome#contact", label: "クリニック紹介" },
];
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 text-sm md:text-base">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-[#06c755] px-4 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-[#05b34b] md:text-sm"
          >
